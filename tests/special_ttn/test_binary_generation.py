...
class TestGenerateBinaryTTNS(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.configs = [
            (12, 3, 2),  # Deeper binary tree
            (12, 2, 2),   # Moderate bond dimension and depth.
            (23, 4, 3),  # Shallow tree with minimal bond dimension
            (35, 3, 2),   # Shallow tree with larger bond dimension
        ]
