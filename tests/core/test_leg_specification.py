...
class TestLegSpecificationInit(unittest.TestCase):
    ...
    def test_empty_init(self):
        leg_spec = LegSpecification(None, None, None)
    ...
    def test_init(self):
        ...
        leg_spec = LegSpecification(parent_leg, child_legs, open_legs,
                                        node)
...
class TestLegSpecificationEquality(unittest.TestCase):
    def setUp(self) -> None:
        self.nodes = [Node(identifier="node1"),
                      Node(identifier="node2")]
        self.parent_id = "parent"
        self.child_ids = ["child1","child2","child3"]

    def test_all_equal(self):
        leg_spec1 = LegSpecification(self.parent_id, self.child_ids,
                                         open_legs = [0,1])
        leg_spec2 = LegSpecification(self.parent_id, self.child_ids,
                                         open_legs = [0,1])
    ...
    def test_parent_not_equal(self):
        leg_spec1 = LegSpecification(self.parent_id, self.child_ids,
                                         open_legs = [0,1])
        leg_spec2 = LegSpecification("other", self.child_ids,
                                         open_legs = [0,1])
    ...
    def test_children_not_equal(self):
        leg_spec1 = LegSpecification(self.parent_id, self.child_ids,
                                         open_legs = [0,1])
        leg_spec2 = LegSpecification(self.parent_id,
                                         ["a","b","c"],
                                         open_legs = [0,1])
        self.assertNotEqual(leg_spec1,leg_spec2)
    ...
    def test_empty_equality(self):
        leg_spec1 = LegSpecification(None, None, None)
        leg_spec2 = LegSpecification(None, None, None)
        self.assertEqual(leg_spec1, leg_spec2)
...
class TestLegSpecMethods(unittest.TestCase):
    ...
    def test_find_leg_values_root(self):
        leg_spec = LegSpecification(None,["c1","c2"],[2],
                                        node=self.nodes["root"])
        leg_spec2 = LegSpecification(None,[],[],
                                        node=self.nodes["root"])
    ...
    def test_find_leg_values_root_split_c1(self):
        leg_spec = LegSpecification(None,["c2"],[2],
                                        node=self.nodes["root"])
        leg_spec2 = LegSpecification(None,["c1"],[],
                                        node=self.nodes["root"])
    ...
    def test_find_leg_values_root_split_c2(self):
        leg_spec = LegSpecification(None,["c1"],[2],
                                        node=self.nodes["root"])
        leg_spec2 = LegSpecification(None,["c2"],[],
                                        node=self.nodes["root"])
    ...
    def test_find_leg_values_root_split_open(self):
        leg_spec = LegSpecification(None,[],[2],
                                        node=self.nodes["root"])
        leg_spec2 = LegSpecification(None,["c1","c2"],[],
                                        node=self.nodes["root"])
    ...
    def test_find_leg_values_root_wrong_order(self):
        leg_spec = LegSpecification(None,["c2","c1"],[2],
                                        node=self.nodes["root"])
        leg_spec2 = LegSpecification(None,[],[],
                                        node=self.nodes["root"])
    ...
    def test_find_leg_values_leaf_split(self):
        leg_spec = LegSpecification("root",[],[],
                                        node=self.nodes["c1"])
        leg_spec2 = LegSpecification(None,[],[1],
                                        node=self.nodes["c1"])
