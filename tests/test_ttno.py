...
class TestTTNOBasics(unittest.TestCase):
    ...
    def test_from_tensorC(self):
        ...
        node10, tensor10 = ptn.random_tensor_node((2, 3, 4, 5), identifier="id10")

        reference_tree.add_root(node1, tensor1)
        reference_tree.add_child_to_parent(node2, tensor2, 0, "id1", 0)
        reference_tree.add_child_to_parent(node3, tensor3, 3, "id2", 3)
        reference_tree.add_child_to_parent(node4, tensor4, 0, "id3", 0)
        reference_tree.add_child_to_parent(node5, tensor5, 2, "id2", 2)
        reference_tree.add_child_to_parent(node6, tensor6, 0, "id5", 0)
        reference_tree.add_child_to_parent(node7, tensor7, 1, "id5", 1)
