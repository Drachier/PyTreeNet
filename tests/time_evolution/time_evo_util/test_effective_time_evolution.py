...
@pytest.mark.parametrize("method", TimeEvoMethod.scipy_modes())
def test_action_based_bond_evolution(method):
    """
    ...
    mode = TimeEvoMode(method, {'rtol': rtol, 'atol': atol})
...
@pytest.mark.parametrize("method", [TimeEvoMethod.EXPM, TimeEvoMethod.CHEBYSHEV, TimeEvoMethod.SPARSE, TimeEvoMethod.FASTEST])
def test_matrix_based_bond_evolution(method):
    """
    Test the bond evolution using matrix-based method.
    """
    node_id = "state_node"
    # Define state node
    state_node, state_tensor = random_tensor_node((4,5),
...
@pytest.mark.parametrize("method", TimeEvoMethod.scipy_modes())
def test_action_based_single_site_evolution(method):
    """
...
@pytest.mark.parametrize("method", [TimeEvoMethod.EXPM, TimeEvoMethod.CHEBYSHEV, TimeEvoMethod.SPARSE, TimeEvoMethod.FASTEST])
def test_matrix_based_single_site_evolution(method):
    """
    Test the single site evolution using matrix-based method.
    """
    node_id = "main_node"
    # Define state node
    state_node, state_tensor = random_tensor_node((4,6,5,2),
