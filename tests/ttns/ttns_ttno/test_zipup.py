...
from pytreenet.random.random_mps_and_mpo import random_mps_and_mpo_by_dimensions

from pytreenet.ttns.ttns_ttno.zipup import zipup

class TestzipupApproachrandomTTN(unittest.TestCase):
    """
    Test the zipup apporach for a random TTNs.
    """
    def setUp(self):
    ...
    def test_small_ttn(self):
        """
        Test the zipup approach for a small TTN.
        """
    ...
    def test_big_ttn(self):
        """
        Test the zipup approach for a bigger TTN.
        """
...
class TestzipupApproachSpecialTTN(unittest.TestCase):
    """
    Test the zipup approach for special TTNs.
    """
    def setUp(self):
        self.svd_params = SVDParameters(float("inf"), float("-inf"), float("-inf"))
    ...
    def test_mps(self):
        """
        Test the zipup approach for an MPS.
        """
    ...
    def test_binary_state(self):
        """
        Test the zipup approach for a binary TTN state.
        """
    ...
    def test_tstar_state(self):
        """
        Test the zipup approach for a T* state.
        """
    ...
    def test_ftps(self):
        """
        Test the zipup approach for a FTPS.
        """
...
class TestCanonZipUpApproachMPStructure(unittest.TestCase):
    """
    Test the zipup approach for an MPS with canonical structure.
    """
    def setUp(self):
        self.svd_params = SVDParameters(float("inf"), float("-inf"), float("-inf"))

    def test_mps_canonical_structure(self):
        """
        Test the zipup approach for an MPS with canonical structure.
        """
        ttns, ttno = random_mps_and_mpo_by_dimensions(7, 3, 20, 15, seed=42)
        result = zipup(ttno,
                       ttns,
                       canonicalize=True,
                       svd_params=self.svd_params)
    ...
    def test_mps_canonical_structure_root_left(self):
        """
        Test the zipup approach for an MPS with canonical structure.
        Here the root is the leftmost node, which is a special case for the zip-up.
        """
        ttns, ttno = random_mps_and_mpo_by_dimensions(7, 3, 20, 15,
                                                      root_site=0,
                                                      seed=42)
        result = zipup(ttno,
                       ttns,
    ...
    def test_mps_canonical_structure_root_right(self):
        """
        Test the zipup approach for an MPS with canonical structure.
        Here the root is the rightmost node, which is a special case for the zip-up.
        """
        ttns, ttno = random_mps_and_mpo_by_dimensions(7, 3, 20, 15,
                                                      root_site=6,
                                                      seed=42)
