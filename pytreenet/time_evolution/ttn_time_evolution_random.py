...
from .time_evoltion_random import TimeEvolution_random
from ..ttns import TreeTensorNetworkState
from ..ttno import TTNO
from ..operators.tensorproduct import TensorProduct
from .time_evoltion_random import TTNTimeEvolutionConfig

class TTNTimeEvolution_random(TimeEvolution_random):
    """
