...
from pytreenet.time_evolution.time_evolution import TimeEvoMode, EvoDirection, TimeEvoMethod
...
def bond_time_evolution(node_id: str,
                        ...
                        mode: TimeEvoMode =  TimeEvoMode(TimeEvoMethod.FASTEST)
                        ) -> ndarray:
    """
...
def effective_bond_evolution(
        state_tensor: NDArray[complex128],
        state_node: Node,
        time_step_size: float,
        tensor_cache: PartialTreeCachDict,
        mode: TimeEvoMode = TimeEvoMode(TimeEvoMethod.FASTEST),
    ...
    Args:
        state_tensor (NDArray[complex128]): The tensor of the state to be
        ...
        mode (TimeEvoMode, optional): The mode of the time evolution. Defaults
            to TimeEvoMode(TimeEvoMethod.FASTEST). If possible, the time evolution is
...
def effective_single_site_evolution(
        state_tensor: NDArray[complex128],
        state_node: Node,
        hamiltonian_tensor: NDArray[complex128],
    ...
    Args:
        state_tensor (NDArray[complex128]): The tensor of the state to be
            updated.
        state_node (Node): The node of the state tensor.
        hamiltonian_tensor (NDArray[complex128]): The tensor of the
            Hamiltonian.
        ...
        forward (EvoDirection, optional): Whether to time evolve forward or backward.
            Defaults to EvoDirection.FORWARD.
    Returns:
        NDArray[complex128]: The updated state tensor after the time
            evolution.
...
def effective_two_site_evolution(
        state_tensor: NDArray[complex128],
        state_node: Node,
        hamiltonian_tensors: NDArray[complex128] |
    ...
    Args:
        state_tensors (NDArray[complex128]): A tensor representing the two
        ...
        state_node (Node): The node corresponding to the state tensor and the
            two sites.
        hamiltonian_tensors (NDArray[complex128] | tuple[NDArray[complex128],
                             NDArray[complex128]]):
