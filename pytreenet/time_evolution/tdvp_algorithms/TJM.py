...
class GSE_TJM_TDVP(OneSiteTDVP):
    def __init__(self, 
...
# TJM
    ...
    def run_trajectory_second_order(self, args):
        _ , evaluation_time,  initial_state, progress_queue = args
    ...
    def run_TJM(self, evaluation_time=1, filepath=None):
        ...
        initial_state = normalize_ttn(self.initial_state)
        ...
        args_list = [
            (i, evaluation_time, initial_state, progress_queue)
