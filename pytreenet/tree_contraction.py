...
def construct_contracted_identifier(tree_tensor_network, node1_id=None, node2_id=None, new_identifier=None):
...
def construct_contracted_tag(node1_tag, node2_tag, new_tag):
    if new_tag == None:
...
def combine_nodes(tree_tensor_network, node1_id, node2_id, new_tag=None, new_identifier=None):
    ...
    new_identifier = construct_contracted_identifier(tree_tensor_network,
                                                     node1_id, node2_id,
                                                     new_identifier)
    new_tag = construct_contracted_tag(node1.tag, node2.tag, new_tag)
