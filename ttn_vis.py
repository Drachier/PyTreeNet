"""
Visualization utilities for PyTreeNet Tree Tensor Network structures.

This module provides enhanced visualization functions for different types of Tree Tensor Network structures:
1. Binary Tree Tensor Network State (TTNS)
2. Symmetric Tree Tensor Network Density Operator (TTNDO) 
3. Intertwined Tree Tensor Network Density Operator (TTNDO)

All visualizations use intelligent node positioning to minimize overlaps and create clear representations.
"""
...
def visualize_intertwined_ttndo(ttndo, title=None, save_path=None, layout_type="radial", simplified_labels=False):
    """
    ...
    if layout_type == "radial":
        ...
        for level_idx, level in enumerate(levels):
            ...
            # Use specific radii for each level, similar to visualize_intertwined_ttndo
            radii = {
